...
<p>Eu uso muito isto pois minhas fotos estão como Creative Commons e muitas pessoas usam para criar conteúdo em blogs ou sites de notícias.</p>');
    ...
    $app->response->write('<form method="post" onsubmit="submit_form(this)"><label for="user_id">User ID</label><input type="text" id="user_id" name="user_id" /><input type="submit" /></form>');
